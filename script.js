...
const birthDatesSorted = inventors.sort((a, b) => a.year - b.year);
console.log(birthDatesSorted);
...
const stringFirstLast = people.map((person) => {
    const [lastName, firstName] = person.split(', ');
    return `${firstName} ${lastName}`;
});
console.log(stringFirstLast);
...
const dataObject = data.reduce((acc, word) => {
...
const olderThan19 = devs.some((dev) => {
...
const everyoneOlderThan19 = devs.every((dev) => {
    const age = currentYear - dev.year;
    return age >= 19
});
...
const id823423 = comments.find(comment => comment.id === 823423);
console.log(id823423);

// Array.prototype.findIndex()
// 11. Find the index of the comment with an id of 123523

const id123523 = comments.findIndex(comment => comment.id === 123523);
console.log(id123523);